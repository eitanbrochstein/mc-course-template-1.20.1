package net.eitan.mccourse.block.entity.renderer;
...
public class GemEmpoweringBlockEntityRenderer implements BlockEntityRenderer<GemEmpoweringStationBlockEntity> {
    ...
    @Override
    public void render(GemEmpoweringStationBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {

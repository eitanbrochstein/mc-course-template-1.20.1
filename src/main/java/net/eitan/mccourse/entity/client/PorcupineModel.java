...
import net.eitan.mccourse.entity.animations.ModAnimations;
...
public class PorcupineModel<T extends PorcupineEntity> extends SinglePartEntityModel<T> {
    ...
    public void setAngles(PorcupineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        updateAnimation(entity.attackAnimationState, ModAnimations.PORCUPINE_ATTACK, ageInTicks, 1f);
        updateAnimation(entity.sitAnimationState, ModAnimations.PORCUPINE_SIT, ageInTicks, 1f);
    }
